...
public class FirebaseManager : MonoBehaviour
{
    ...
    public void RemoveDataButton()
    {
        StartCoroutine(RemoveDataFromTable());
    }

    public void EditButton()
    {
        StartCoroutine(EditUserNameAndPassword(emailRegisterField.text, passwordRegisterField.text));
    }
    ...
    private IEnumerator RemoveDataFromTable()
    {
        User.DeleteAsync();
    ...
    private IEnumerator EditUserNameAndPassword(string _email, string _password)
    {
        ...
        {
            //Call the Firebase auth update function
            var RegisterTask = auth.CurrentUser.UpdatePasswordAsync(_password);
            RegisterTask = auth.CurrentUser.UpdateEmailAsync(_email);
